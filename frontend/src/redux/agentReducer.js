...
const initialAgents = [
  {
    ...
    type: "ai",
    model: DEFAULT_MODEL,
    systemPrompt: "With reference to any provided code, analyze the user's query, outline the problem described, and suggest efficient and elegant solutions. Do NOT return the full contents of files; return only lines and functions changed.",
    output: "",
    sourceType: "user"
  },
  {
...
const agentReducer = (state = initialState, action) => {
  switch(action.type) {
    ...
    case 'CLEAR_AGENT_CACHE':
      return {...initialState, savedAgentConfigurations: state.savedAgentConfigurations};
